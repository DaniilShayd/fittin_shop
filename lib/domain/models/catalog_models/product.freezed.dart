...
class _$_Product implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, picture: $picture, price: $price, oldPrice: $oldPrice, name: $name, article: $article, rating: $rating, reviewsCount: $reviewsCount, cityFias: $cityFias)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, picture, price, oldPrice,
      name, article, rating, reviewsCount, cityFias);
