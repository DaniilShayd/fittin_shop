...
abstract class $InfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int count, String? next, String? prev});
}
...
class _$_Info implements _Info {
  _$_Info({required this.count, required this.next, required this.prev});
  ...
  @override
  String toString() {
    return 'Info(count: $count, next: $next, prev: $prev)';
  }
